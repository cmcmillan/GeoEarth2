...
package geoearth.test.rtree.index;
...
public class SpatialIndexFactory
{
    ...
    private final static Logger log = LoggerFactory.getLogger(SpatialIndexFactory.class.getName());
	...
	String className = "geoearth.test.rtree.index." + type;
	try
	{
